      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div className="rounded-md border bg-muted/30 p-3 text-sm space-y-1">
            ...
            <p className="text-muted-foreground">Configure category rules in the UI after import if needed. Team Prizes use the Team Prizes toggle in Prize Mode (manual flow).</p>
