-- Add type_label column to players table (Swiss-Manager "Type" column)
-- This stores values like PC, S60, F14, U15, Section A, etc.
ALTER TABLE public.players 
ADD COLUMN IF NOT EXISTS type_label text;

-- Add comment for documentation
COMMENT ON COLUMN public.players.type_label IS 'Generic category label from Swiss-Manager Type column (PC, S60, F14, etc.)';

-- Update import_replace_players function to include type_label
...
begin
  ...
  -- Step 3: insert all uploaded players (includes group_label and type_label)
